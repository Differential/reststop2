...
In fact, some folks seem to have done just that with this
[`restivus`](https://github.com/krose72205/meteor-restivus) package. It shares
all the features of `reststop2`, with a similar API and planned support for
Meteor 0.9.0+. Check it out!
